...
GRANT EXECUTE ON PROCEDURE  `Piscine-Roma-DB`.is_CF_insegnante_valid TO 'insegnante'@'localhost';

########### ADDETTO SEGRETERIA #############
CREATE USER 'addetto_segreteria'@'localhost' IDENTIFIED BY 'asegreteria123';
GRANT EXECUTE ON PROCEDURE  `Piscine-Roma-DB`.is_piscina_addetto_valid TO 'addetto_segreteria'@'localhost';
